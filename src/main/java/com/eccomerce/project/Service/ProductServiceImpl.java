...
public class ProductServiceImpl implements ProductService{
    ...
    public ProductDTO addProduct(ProductDTO product, Long categoryId) {
        ...
        if (isProductNotPresent) {
            Product productes;
            productes = modelMapper.map(product, Product.class);
            productes.setImage("default.png");
            productes.setCategory(category);
            double specialPrice = product.getPrice() -
                    ((product.getDiscount() * 0.01) * product.getPrice());
            product.setSpecialPrice(specialPrice);
            Product savedProduct = productRepository.save(productes);
    ...
    @Override
    public ProductResponse updateProduct(ProductDTO productDtos, Long productId) {
        return null;
    }
